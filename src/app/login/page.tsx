    ...
    <div className="min-h-screen bg-main-gradient flex items-center justify-center px-4">
      <div className="max-w-sm w-full">
        ...
        <div className="bg-[#1A1A2E] rounded-2xl p-8 border border-white/5 text-center">
          ...
          {error && (
            <div className="bg-[#F87171]/10 border border-[#F87171]/30 rounded-xl p-3 mb-4 text-[#F87171] text-sm">
              {error}
            </div>
          )}
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3 rounded-xl hover:bg-gray-100 transition-colors disabled:opacity-50"
          >
          ...
          <p className="text-[#9CA3AF] text-xs mt-6">
            เข้าสู่ระบบเพื่อเก็บคะแนน, บันทึกรายการโปรด
            <br />
